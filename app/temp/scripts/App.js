...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Modules_Person__ = __webpack_require__(5);
...
console.log(__WEBPACK_IMPORTED_MODULE_0__Modules_Person__["a" /* default */]);

const pedro = new __WEBPACK_IMPORTED_MODULE_0__Modules_Person__["a" /* default */]("Pedro", "Pink");
const nelson = new __WEBPACK_IMPORTED_MODULE_0__Modules_Person__["a" /* default */]("Nelson", "Gray");
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = AnotherAnotherPerson;
function AnotherAnotherPerson(name, color) {
    this.name = name;
    this.color = color;
    this.print = function(){
        console.log("Hello my name is " + this.name + " and my fav color is " + this.color); 
